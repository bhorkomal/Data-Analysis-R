...
#----Read the dataset------
getwd()
setwd("C:/Users/atharva shipping/Documents/Data")
Plan_Dataset <- read.csv("InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
# Equation obtained-> Annual_EE_Contri=618+7.8*Age_Grp1+15.1*Age_Grp2-5.2*Employee_Class1-333.5*Coverage.Level1+68.89*Coverage.Level2

#Initially, we took, dataset of 2017 as training data for building model.
#---Taking dataset of 2018 as test data.--------
setwd("C:/Users/atharva shipping/Documents/Data")
sm2 <- read.csv("InsurancePlanSubscriptions-2018.csv")
View(sm2)
