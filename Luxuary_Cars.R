...
dataset = read.csv('F:/WORK/rWork/rProjects/Analytics_Edge/Analytics_Edge_R/data/Luxury_Cars.csv')
View(dataset)
...
regressor = lm(MPG_Mileage ~ Type2+#Type1
                 #+Origin1
                 Origin2+
...
library(Metrics)
mape(testData$Pred_MPG,testData$MPG_Mileage)
